...
function getDialogueTranslation(item, lang) {
  ...
  if (trans && typeof trans === "object") {
    if (l === "kr") return _trimStr(trans.kr) || _trimStr(trans.ko) || "";
    if (l === "jp") return _trimStr(trans.jp) || _trimStr(trans.ja) || "";
    if (l === "cn") return _trimStr(trans.cn) || _trimStr(trans.zh) || "";
    return _trimStr(trans.en) || "";
  }
  ...
  if (l === "cn") {
    return (
      _trimStr(item.cn) ||
      _trimStr(item.zh) ||
      _trimStr(item.translationCn) ||
      _trimStr(item.translation_cn) ||
      ""
    );
  }
