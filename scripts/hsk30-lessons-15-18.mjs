...
export const lesson15 = L(15, {
  ...
  practice: [
    ...
    },
    {
      ...
      options: pinOpts("kàn", "kān", "kǎn", "kàng"),
      answer: "A",
      explanation: {
        cn: "「看」读 kàn。",
        kr: "「看」는 kàn입니다.",
    ...
    },
    {
      ...
      options: opt4(
        ["你给谁打电话？", "누구한테 전화해?", "Who are you calling?", "だれに電話してる？"],
        ["你有时间吗？", "시간 있어?", "Do you have time?", "時間ある？"],
        ["你看一下。", "한번 봐.", "Take a look.", "ちょっと見て。"],
        ["你有什么事？", "무슨 일 있어?", "What’s up?", "どうした？"]
      ),
      answer: "A",
      explanation: {
        cn: "「给谁」引出通话对象。",
...
export const lesson16 = L(16, {
  ...
  practice: [
    ...
    },
    {
      ...
      options: pinOpts("juéde", "juédé", "jüéde", "juède"),
      answer: "A",
      explanation: {
        cn: "「觉得」读 juéde。",
        kr: "「觉得」는 juéde입니다.",
    ...
    },
    {
      ...
      options: opt4(
        ["外边雨非常大。", "밖에 비가 엄청 세요.", "The rain outside is very heavy.", "外は雨がとても強い。"],
        ["今天天气很好。", "날씨가 아주 좋아요.", "The weather is nice.", "今日はいい天気です。"],
        ["我不想去。", "가기 싫어요.", "I don’t want to go.", "行きたくない。"],
        ["现在时间还早。", "아직 이르다.", "It’s still early.", "まだ早い。"]
      ),
      answer: "A",
      explanation: {
        cn: "「雨非常大」表示雨势大。",
...
export const lesson17 = L(17, {
  ...
  practice: [
    ...
    },
    {
      ...
      options: opt4(
        ["你们都会说汉语吗？", "둘 다 중국어 할 수 있어요?", "Can you both speak Chinese?", "二人とも中国語が話せますか。"],
        ["你是大学生吗？", "대학생이에요?", "Are you a college student?", "大学生ですか。"],
        ["我是小学生。", "초등학생이에요.", "I’m a primary student.", "小学生です。"],
        ["我正在读书呢。", "책 읽고 있어요.", "I’m reading.", "読書してます。"]
      ),
      answer: "A",
      explanation: {
        cn: "「都」总括「你们」全体。",
...
export const lesson18 = L(18, {
  ...
  practice: [
    ...
    },
    {
      ...
      options: pinOpts("zhǐ", "zhī", "zǐ", "zhì"),
      answer: "A",
      explanation: {
        cn: "「只」读 zhǐ。",
        kr: "「只」는 zhǐ입니다.",
    ...
    },
    {
      ...
      options: opt4(
        ["你听见有人在唱歌吗？", "누가 노래하는 소리 들려요?", "Do you hear someone singing?", "歌ってるの聞こえる？"],
        ["你喜欢唱歌吗？", "노래 부르는 거 좋아해?", "Do you like singing?", "歌うの好き？"],
        ["这首歌很好听。", "이 노래 좋다.", "This song sounds great.", "この歌はいい。"],
        ["我妹妹在唱歌呢。", "여동생이 노래해요.", "My sister is singing.", "妹が歌ってます。"]
      ),
      answer: "A",
      explanation: {
        cn: "「听见」问是否听到声音。",
