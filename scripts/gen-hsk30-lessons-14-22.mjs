...
const lesson14 = L(14, {
  ...
  practice: [
    ...
    },
    {
      ...
      prompt: {
        cn: "爸爸提议「我开车送你吧。」这句话主要是在：",
        kr: "「我开车送你吧。」는 주로 무슨 뜻이에요?",
        en: "「我开车送你吧」 mainly offers to:",
        jp: "「我开车送你吧」は何を提案していますか。",
      },
      options: opt4(
        ["开车送对方一程", "차로 데려다 주겠다", "Give a ride", "車で送る"],
        ["问对方有没有钱", "돈이 있냐고 묻기", "Ask if they have money", "お金があるか聞く"],
        ["让对方买票", "표 사라고 하기", "Tell them to buy tickets", "切符を買わせる"],
        ["说车坏了", "차가 고장 났다", "Say the car broke", "車が壊れたと言う"]
      ),
      answer: "A",
      explanation: {
        cn: "「吧」在此表提议，爸爸主动提出开车送汤姆。",
        kr: "「吧」로 제안—아빠가 차로 데려다 주겠다고 합니다.",
        en: "吧 makes it a suggestion—Dad offers a ride.",
        jp: "「吧」で提案、送ってあげると言っています。",
      },
    },
    {
      id: "hsk30_l14_p4",
      ...
      options: opt4(
        ["乘坐某种交通工具", "교통수단에 탄다", "Take (a vehicle)", "乗り物に乗る"],
        ["坐在椅子上", "의자에 앉다", "Sit on a chair", "椅子に座る"],
        ["坐下休息", "앉아 쉬다", "Sit down and rest", "座って休む"],
        ["把东西放下", "물건을 내려놓다", "Put something down", "物を置く"]
      ),
      answer: "A",
      explanation: {
        cn: "「坐」在此与火车搭配，表示乘坐。",
        kr: "「坐」는 기차 등에 ‘탄다’는 뜻이에요.",
        en: "坐 + train = ride the train.",
        jp: "「坐」は電車などに「乗る」。",
      },
    },
  ],
